...
<div class="max-w-6xl mx-auto space-y-8 animate-fade-in pb-12">
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="text-right">
                <div class="px-5 py-3 bg-gray-100 rounded-xl mb-3 border border-gray-200">
                    <p class="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1">Dokumen Keuangan</p>
                    <p class="text-base font-black text-tni-900">MT/FIN/{{ date('Ymd') }}</p>
                </div>
                <p class="text-xs font-bold text-gray-400">Dicetak: {{ now()->format('d/m/Y H:i') }} WIB</p>
            </div>
        </div>
        <div class="text-center mt-12">
            <h2 class="text-2xl font-black uppercase border-b-2 border-black inline-block pb-1 mb-2">Laporan Estimasi Operasional & Efisiensi</h2>
    ...
    <!-- Stats Overview -->
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8 print:grid-cols-3 print:gap-4">
