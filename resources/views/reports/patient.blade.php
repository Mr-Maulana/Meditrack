...
<div class="max-w-6xl mx-auto space-y-8 animate-fade-in pb-12">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 no-print">
        <div>
            <h2 class="text-3xl font-black text-tni-900 tracking-tight">Analisis Data Pasien</h2>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div class="bg-white rounded-3xl p-8 shadow-xl border border-gray-100 text-center">
            ...
            <p class="text-4xl font-black text-tni-900">{{ $patientStats['total'] }}</p>
        </div>
        <div class="bg-white rounded-3xl p-8 shadow-xl border border-gray-100 text-center">
            <p class="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-2">Pasien Ber-Resep</p>
            <p class="text-4xl font-black text-gold-500">{{ $patientStats['with_prescriptions'] }}</p>
        </div>
        <div class="bg-white rounded-3xl p-8 shadow-xl border border-gray-100 text-center">
            <p class="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-2">Pasien Dilayani Antar</p>
            <p class="text-4xl font-black text-blue-500">{{ $patientStats['with_deliveries'] }}</p>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-1 bg-white rounded-[2.5rem] shadow-xl border border-gray-100 overflow-hidden">
                ...
                <table class="min-w-full divide-y divide-gray-100">
                    <thead>
                        <tr class="bg-gray-50/50">
                            <th class="px-6 py-4 text-left text-[10px] font-black text-gray-400 uppercase">Nama & Kode</th>
                            <th class="px-6 py-4 text-left text-[10px] font-black text-gray-400 uppercase">Diagnosis Utama</th>
                            <th class="px-6 py-4 text-center text-[10px] font-black text-gray-400 uppercase">Resep</th>
                            <th class="px-6 py-4 text-right text-[10px] font-black text-gray-400 uppercase">Tgl Daftar</th>
                        </tr>
                    </thead>
