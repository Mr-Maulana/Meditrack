...
<div class="max-w-4xl mx-auto space-y-8 animate-fade-in pb-12">
    ...
    <div class="bg-white rounded-[2.5rem] shadow-xl border border-gray-100 overflow-hidden">
        ...
        <form id="patientForm" action="{{ route('patients.store') }}" method="POST" class="p-10">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
                ...
                <div class="space-y-8">
                    ...
                    <div class="space-y-6">
                        <div>
                            <label for="patient_code" class="block text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-3 ml-1">No. RM <span class="text-red-500">*</span></label>
                            <div class="relative group">
                                ...
                                <input type="text" id="patient_code" name="patient_code" value="{{ old('patient_code') }}" required 
